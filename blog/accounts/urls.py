...
from .views import RegisterView, EditView, PasswordsChangeView, ProfilePageView, EditProfilePageView, CreateProfileView
...
urlpatterns = [
    ...
    path('create_profile/',
         CreateProfileView.as_view(), name='create-profile'),
]
